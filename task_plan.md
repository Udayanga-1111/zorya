...
## EPIC 5: Zorya Telemetry Chart & PDPA Settings
# Zorya Task Plan — Sprint 1 (July 21 – July 26, 2026)
...
### Phase 1: Backend FastMCP (`celestial_server.py`)
- [ ] Implement `calculate_natal_chart` tool with 12:00 PM fallback
- [ ] Implement `calculate_transits` tool
- [ ] Implement `calculate_dasha_triguna` tool

### Phase 2: DB & API Routes
- [ ] Update Prisma schema (`User` profile & telemetry fields)
- [ ] `GET /api/chart/telemetry` API route
- [x] `PATCH /api/settings/profile` API route
- [x] `GET /api/settings/privacy/export` API route
- [x] `DELETE /api/settings/privacy/account` API route (PDPA Erasure)

### Phase 3: Frontend `/chart` Page
- [x] Glassmorphism `AstroRadarWheel` component
- [x] `CognitiveBaselineCard` component (Moon/Sun CBT translations)
- [x] `ActiveTelemetryCard` component (Mahadasha & Triguna Guna states)
- [x] `DisclaimerFooter` component

### Phase 4: Frontend `/settings` Page
- [x] `ProfileTelemetryForm` component + "Unknown Birth Time" toggle
- [x] Active Consent viewer
